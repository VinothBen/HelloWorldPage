...
.bkimage{
  ...
  background-image: url('<c:url value="/resources/webdesign/images/personal2.jpg" />');
...
<body>
	...
	<br>
		...
		<h3 style="font-size:20px">Personal	Loan:</h3>
			<form action="addpersonalloan" name="personalloan_page" method="POST">
				<label>Name</label> 
				...
				<input type="text" id="emailid" name="emailid"
					...
					placeholder="Your ten digit mobile no.." required>
					 <label>State</label>
